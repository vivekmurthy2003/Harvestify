...
#### Deployment is done using [deploy](https://github.com/vivekmurthy2003/Harvestify/tree/deploy) branch
...
- **Note:** The master branch doesn't have the updated code used for deployment, to download the updated code used for deployment you can use the following command
  ```
  ❯ git clone -b deploy https://github.com/vivekmurthy2003/Harvestify.git 
  ```
...
## Contribute 👨‍💻
Please read [CONTRIBUTING.md](https://github.com/vivekmurthy2003/Harvestify/blob/master/CONTRIBUTING.md) for details on our code of conduct, and the process for submitting pull requests to us.
...
## License 📝
This project is licensed under [GNU (GENERAL PUBLIC LICENSE)](https://github.com/vivekmurthy2003/Harvestify/blob/master/LICENSE).

## Contact 📞

#### If you have any doubt or want to contribute feel free to email me on modivivek02@gmail.com
